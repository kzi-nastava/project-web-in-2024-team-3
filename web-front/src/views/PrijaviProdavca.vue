<template>
    <div id="prijaviProdavca" class="container mt-5">
      <h1 class="text-center">Prijavi Prodavca</h1>
  ...
  export default {
    ...
    methods: {
      ...
      submitPrijava() {
        ...
        axios
          .post(`http://localhost:8081/api/prijavi-prodavca/${id}`, prijava, { withCredentials: true })
          .then((res) => {
